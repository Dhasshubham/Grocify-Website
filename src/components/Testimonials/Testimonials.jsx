  ...
  return (
    <section>
      <div className="max-w-[1400px] px-10 mx-auto py-20">
        ...
        {/* two button  */}
        <div className="py-5 flex justify-end gap-x-3 mt-5">
          <button className="custom-prev text-2xl text-zinc-800 flex rounded-lg w-11 h-11 bg-zinc-100 justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-600 hover:text-white cursor-pointer">
            <IoIosArrowBack />
          </button>
          <button className="custom-next flex text-2xl text-zinc-800 rounded-lg w-11 h-11 bg-zinc-100 justify-center items-center hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-600 hover:text-white cursor-pointer">
            <IoIosArrowForward />
          </button>
        </div>
            ...
            return (
              <SwiperSlide className="bg-zinc-100 rounded-xl p-8">
                <div className="flex gap-5 items-center">
                  <div className="w-16 h-16 rounded-full outline-2 outline-orange-500 outline-offset-2 overflow-hidden">
                    <img src={item.image} className="w-full h-full "/>
                  </div>

                  <div>
                    <h5 className="text-xl font-bold">{item.name}</h5>
                    <p className="text-zinc-800"> {item.profession}</p>
